...
6. **LLM Constraint:** The LLM model uses gemini-3.1-flash-lite-preview. It will most likely be down most of the time due to high demand. Not sure how I can fix it without paying for it. Please take that into account when prompting it.
